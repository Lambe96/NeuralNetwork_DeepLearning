...
import numpy as np
from Conv_autoenc import Encoder, Decoder
from Conv_autoenc import train_epoch, test_epoch
import optuna
...
class Hype_Select_Convaut(nn.Module):
    def __init__(self, 
                train_data, 
                test_data,
                n_epochs_range = 50,
        ...
        super(Hype_Select_Convaut, self).__init__()
